...
RDB are Databases that store information in tabular structures while SQL is a language for interacting with databases
...
1 to many relationship on each table to the other
